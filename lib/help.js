...
const COMMAND_HELP = {
  ...
  recurringpoll: {
    ...
    description: 'Schedules automated match polls that are posted to the group on specific days of the week or everyday.',
    usage: '!recurringpoll [size] <matchTime> [at <postTime>] [days] [no-matchups]',
    aliases: ['!recurringpoll', '!recurringpolls', '!schedulepoll', '!dailypoll', '!cancelrecurringpoll', '!pauserecurringpoll', '!resumerecurringpoll', '!clearallrecurringpolls'],
    examples: [
...
const COMMAND_ALIAS_MAP = {
  ...
  recurringpoll: 'recurringpoll', recurringpolls: 'recurringpoll', schedulepoll: 'recurringpoll', dailypoll: 'recurringpoll', everydaypoll: 'recurringpoll', cancelrecurringpoll: 'recurringpoll', pauserecurringpoll: 'recurringpoll', resumerecurringpoll: 'recurringpoll', clearallrecurringpolls: 'recurringpoll',
...
function helpText(specificCmd = null) {
  ...
  return [
    ...
    '',
    '💡 *Tip:* Send `!help <command>` (e.g. `!help courts`, `!help poll`, `!help score`, `!help ratings`) for detailed usage and examples.'
  ].join('\n');
}
